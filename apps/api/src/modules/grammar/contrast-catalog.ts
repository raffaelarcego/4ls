...
export const CONTRAST_TOPICS: ContrastTopic[] = [
  ...
  {
    id: 'no-articles',
    title: 'A língua sem artigo nenhum',
    question: 'Como digo "o livro" e "um livro" em russo, se não existe artigo?',
    targets: ['ru'],
    groups: [['ru'], ['en'], ['pt', 'es', 'de']],
    behavior: {
      ru: 'Não existe artigo, nem definido nem indefinido. "Книга" é livro, o livro ou um livro. Quando a diferença importa, ela vem da ORDEM: o que já é conhecido abre a frase, o que é novidade fica para o fim.',
      pt: 'Artigo obrigatório e ainda concordando em gênero e número: o/a/os/as, um/uma.',
      es: 'Igual ao português, com as mesmas duas séries.',
      de: 'Artigo obrigatório e ainda mudando de forma conforme o caso: der/den/dem/des.',
      en: 'Artigo obrigatório no singular contável (a/an), mas ausente em conceitos gerais e incontáveis — o sistema mais frouxo dos quatro.',
    },
    examples: [
      {
        gloss: 'o livro está na mesa — livro já conhecido',
        pt: 'O livro está na mesa.',
        en: 'The book is on the table.',
        es: 'El libro está en la mesa.',
        de: 'Das Buch liegt auf dem Tisch.',
        ru: 'Книга на столе.',
        note: 'Sem artigo e sem verbo: o russo corta as duas coisas que as outras quatro línguas consideram obrigatórias.',
      },
      {
        gloss: 'tem um livro na mesa — livro é novidade',
        pt: 'Tem um livro na mesa.',
        en: 'There is a book on the table.',
        es: 'Hay un libro en la mesa.',
        de: 'Auf dem Tisch liegt ein Buch.',
        ru: 'На столе книга.',
        note: 'Em russo mudou só a ordem: "книга" foi para o fim e virou a novidade. Onde as outras línguas trocam o artigo, o russo troca a posição.',
      },
    ],
    bridge:
      'Você já faz isso em português sem perceber, só que com o artigo junto: "o livro está na mesa" apresenta algo conhecido, "tem um livro na mesa" apresenta algo novo — e repare que a segunda também mudou a ordem, jogando o livro para depois do verbo. O russo ficou só com essa metade. Não é uma distinção que sumiu: é a mesma distinção carregada pela ordem em vez da palavrinha.',
    trap: {
      wrong: 'Одна книга на столе. (querendo dizer "tem um livro na mesa")',
      right: 'На столе книга.',
      why: '"Один" é o numeral UM, não o artigo indefinido. Usá-lo como artigo faz a frase dizer "um livro, e não dois".',
    },
    level: 'A1',
  },
  {
    id: 'aspect',
    title: 'Todo verbo russo vem em par',
    question: 'Por que cada verbo russo tem duas formas, como "делать" e "сделать"?',
    targets: ['ru'],
    groups: [['ru'], ['pt', 'es'], ['en'], ['de']],
    behavior: {
      ru: 'Os verbos vêm em PARES de aspecto. O imperfectivo (делать) é o processo, o hábito, a repetição; o perfectivo (сделать) é a ação concluída, com resultado. O perfectivo não tem presente: conjugado no presente, ele vira futuro.',
      pt: 'A mesma distinção existe, mas mora no TEMPO verbal: "fazia" contra "fiz". O verbo é um só.',
      es: 'Igual ao português: "hacía" contra "hice".',
      en: 'Aproxima-se com o contínuo ("I was doing" contra "I did"), mas sem a obrigação de escolher.',
      de: 'Praticamente não marca isso: "ich machte" serve para os dois sentidos e o contexto resolve.',
    },
    examples: [
      {
        gloss: 'eu fazia o dever de casa — processo, sem dizer se acabou',
        pt: 'Eu fazia o dever de casa.',
        en: 'I was doing my homework.',
        es: 'Hacía la tarea.',
        de: 'Ich machte die Hausaufgaben.',
        ru: 'Я делал домашнее задание.',
      },
      {
        gloss: 'eu fiz o dever de casa — acabou, está pronto',
        pt: 'Eu fiz o dever de casa.',
        en: 'I did my homework.',
        es: 'Hice la tarea.',
        de: 'Ich habe die Hausaufgaben gemacht.',
        ru: 'Я сделал домашнее задание.',
        note: 'Em russo mudou o VERBO (делал → сделал), não o tempo. Em português e espanhol mudou o tempo. Em alemão não mudou nada de essencial.',
      },
    ],
    bridge:
      'Esta distinção já está na sua cabeça — ela só mudou de lugar. Quando você escolhe entre "fazia" e "fiz", está escolhendo exatamente o que o russo escolhe entre делал e сделал: processo ou resultado. A diferença é que o português carrega isso na terminação do tempo verbal e o russo carrega no próprio verbo, antes de conjugar. Você não vai aprender um conceito novo; vai aprender a tomar a mesma decisão um passo mais cedo.',
    trap: {
      wrong: 'Я сделаю домашнее задание сейчас. (querendo dizer "estou fazendo agora")',
      right: 'Я делаю домашнее задание сейчас.',
      why: 'Perfectivo no presente não significa presente: significa futuro. "Сделаю" é "vou fazer (e terminar)". Para o que está em curso agora, só o imperfectivo serve.',
    },
    level: 'B1',
  },
  {
    id: 'motion-verbs',
    title: 'Ir a pé ou ir de carro',
    question: 'Por que o russo me obriga a escolher como eu vou antes de dizer que vou?',
    targets: ['ru', 'de'],
    groups: [
      ['ru', 'de'],
      ['pt', 'es', 'en'],
    ...
    behavior: {
      ru: 'O verbo de movimento já diz o meio: идти/ходить é a pé, ехать/ездить é em veículo. E ainda separa trajeto determinado (идти) de ida e volta ou hábito (ходить).',
      de: 'Faz metade disso: "gehen" é a pé e "fahren" é de veículo. A escolha é obrigatória, como em russo.',
      pt: 'Um verbo só, "ir", para tudo. O meio, se importar, vem depois numa preposição: "de ônibus".',
      es: 'Igual ao português: "ir" cobre tudo.',
      en: 'Igual: "to go" cobre tudo, e o meio vem em "by bus", "on foot".',
    },
    examples: [
      {
        gloss: 'eu vou ao trabalho de ônibus',
        ...
        note: 'Alemão e russo já escolheram o verbo de veículo (fahren, ехать) antes de mencionar o ônibus. Português, espanhol e inglês usam o verbo genérico e deixam o meio para o fim.',
      },
      {
        gloss: 'nós vamos ao cinema — a pé',
        pt: 'Nós vamos ao cinema.',
        en: 'We are going to the cinema.',
        es: 'Vamos al cine.',
        de: 'Wir gehen ins Kino.',
        ru: 'Мы идём в кино.',
        note: 'Aqui os dois trocam para o verbo de andar (gehen, идти). Em português a frase é a mesma dos dois casos.',
      },
    ],
    trap: {
      wrong: 'Я иду в Москву. (querendo dizer "vou a Moscou")',
      right: 'Я еду в Москву.',
      why: '"Идти" é ir com os próprios pés. Dizer "иду в Москву" anuncia uma caminhada até Moscou. O alemão comete o mesmo deslize com "ich gehe nach Berlin".',
    },
    level: 'A2',
  },
  {
